...
- The backdrop, starfield, solid Sun styling, body surface accents, lit highlights, and frame-filled canvas layout are presentation effects in `src/render/renderer.c` and `src/main.c`; they never feed back into SI-unit body state.
