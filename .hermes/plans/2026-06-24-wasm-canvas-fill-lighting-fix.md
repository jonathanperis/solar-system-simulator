...
- Use raylib render dimensions for drawing, then let CSS fill the visible canvas frame while preserving raylib/Emscripten's stable WebGL backing buffer.
...
- Local browser inspection of the WASM page: full-frame viewport, no right strip, no dark bullseye Sun, no displaced glow.
