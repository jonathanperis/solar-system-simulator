...
- Resize the raylib canvas and render texture to the CSS canvas size on the web build.
...
- Local browser inspection of the WASM page: full-width canvas, no right strip, no dark bullseye Sun, no displaced glow.
