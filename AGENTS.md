...
- Renderer polish lives at the boundary: starfield samples, solid Sun styling, body styles, lit highlights, smooth focus, and viewport-matched render textures must not mutate physics state.
